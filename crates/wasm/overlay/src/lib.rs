...
pub async fn get_overlay_data(input: JsValue) -> Result<String, String> {
    ...
    let github_org_data = deployed_full_dataset.github_org_data;
    ...
    let datasets = Datasets {
        ...
        full: Full::new(&landscape_data, &crunchbase_data, &github_data, &github_org_data),
