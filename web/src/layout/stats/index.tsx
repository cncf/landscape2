  ...
  return (
    <>
      <main class="flex-grow-1 container-fluid d-none d-lg-block px-4 position-relative">
        <div class="d-flex flex-row" classList={{ [styles.loadingContent]: isUndefined(stats()) }}>
          <Show when={!isUndefined(stats())} fallback={<Loading spinnerClass="position-fixed top-50 start-50" />}>
