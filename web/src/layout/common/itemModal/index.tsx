    ...
    async function fetchItemInfo() {
      try {
        ...
        if (!isUndefined(itemTmp)) {
          ...
          // TODO - display error when no item
                ...
                <div class={`position-relative border ${styles.fieldset}`}>
                  ...
                  <Show when={!isUndefined(mainRepo())}>
                    ...
                    <Show when={!isUndefined(mainRepo()!.github_data)}>
                      ...
                      <Show
                        when={
                          !isUndefined(mainRepo()!.github_data!.languages) &&
                          !isEmpty(mainRepo()!.github_data!.languages)
                        }
                      >
                        <div class="mt-4">
              ...
              <Show when={!isUndefined(itemInfo()!.summary)}>
                <div class={`position-relative border ${styles.fieldset}`}>
                  ...
                  <div class={`my-2 ${styles.summary}`}>
                    <Show
                      when={!isUndefined(itemInfo()!.summary!.intro_url) && !isEmpty(itemInfo()!.summary!.intro_url)}
                    >
                    ...
                    <Show
                      when={!isUndefined(itemInfo()!.summary!.tags) && !isEmpty(compact(itemInfo()!.summary!.tags!))}
                    >
                      <div class={styles.summaryBlock}>
