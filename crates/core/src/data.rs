...
/// Type alias to represent some repositories' GitHubOrg data.
pub type GithubOrgData = HashMap<String, GithubOrganizationStats>;
...
#[derive(Debug, Clone, Default, PartialEq, Serialize, Deserialize)]
pub struct GithubOrganizationStats {
    pub url: String,
    pub generated_at: DateTime<Utc>,
