...
use crate::{
    data::{CrunchbaseData, GithubData, GithubOrgData, LandscapeData},
...
pub mod full {
    use crate::data::{CrunchbaseData, GithubData, GithubOrgData, Item, LandscapeData};
    use serde::{Deserialize, Serialize};
...
mod tests {
    ...
    fn datasets_new() {
        let input = NewDatasetsInput {
            ...
            github_org_data: &GithubOrgData::default(),
            guide: &None,
