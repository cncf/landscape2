  ...
  <>
    {(() => {
      switch (props.kind) {
        ...
        case SVGIconKind.Documentation:
          return (
            <svg
              className={props.className}
              stroke="currentColor"
        ...
        case SVGIconKind.OpenssfBestPractices:
          return (
            <svg
              className={props.className}
              stroke="currentColor"
        ...
        case SVGIconKind.StackOverflow:
          return (
            <svg
              className={props.className}
              stroke="currentColor"
